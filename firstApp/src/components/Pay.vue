    ...
    <div class="i_bg">
      ...
      <div class="content mar_20">
        <div class="two_bg">
          ...
          <table v-for="(val,key) in address" border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
            <tr>
              <td class="p_td" width="160">收货人</td>
              <td width="395">{{val.s_h_name}}</td>
            </tr>
            <tr>
          ...
          <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
            <tr height="70">
              <td align="right">
                <b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;">￥{{z_price}}</span></b>
              </td>
            </tr>
            <tr height="70">
              <td align="right"><img src="../assets/images/btn_sure.gif" @click="paying" /></td>
            </tr>
          </table>
    ...
    export default {
        ...
        mounted () {
          ...
          .then(res=>{
            this.h_arr=res.data
            var zz=0
            //console.log(this.h_arr.data)
            $.each(this.h_arr,function(val,key){
              zz+=key[0].number * key[0].price
              // console.log(key)
            })
            // console.log(zz)
            this.z_price=zz
            console.log(this.z_price)
          }),
          axios.post(this.url+'/pay/toaddress',{
            token : localStorage.getItem("token"),
          })
          .then(res=>{
        ...
        methods : {
          paying (){
            axios.post(this.url+'/pay/paying',{
              token : localStorage.getItem("token"),
              h_arr :this.h_arr,
              address : this.address,
              z_price : this.z_price,
            })
            .then(res=>{
              console.log(res.data)
